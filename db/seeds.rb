...
AvailableDate.destroy_all
  times_square = AvailableDate.create(property_id: 1, a_date: "2014-04-20", level: "no idea")
  queens_location = AvailableDate.create(property_id: 2, a_date: "2014-04-27", level: "no idea")
  fancy_shmancy = AvailableDate.create(property_id: 3, a_date: "2014-05-15", level: "no idea")
  best_of_queens = AvailableDate.create(property_id: 4, a_date: "2014-06-15", level: "no idea")
  right_thing = AvailableDate.create(property_id: 5, a_date: "2014-08-15", level: "no idea")
  viva_bushwick = AvailableDate.create(property_id: 6, a_date: "2014-06-15", level: "no idea")
  financial_district = AvailableDate.create(property_id: 7, a_date: "2014-07-15", level: "no idea")